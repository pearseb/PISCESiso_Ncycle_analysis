...
data = nc.Dataset('ncycle_changes_ndeponly.nc','r')
...
plt.text(0.5,1.075, '$\Delta$ nitrogen deposition = 26.1 Tg N yr$^{-1}$', transform=ax1.transAxes, fontsize=fstic, ha='center', va='center')
...
#proj.drawparallels(range(domain_draw[0], domain_draw[2]+1, dlat), labels=[False,True,False,False], color=(.3,.3,.3), linewidth=0, fontsize=fstic)
plt.text(0.5,1.075, '$\Delta$ nitrogen fixation = -12.0 Tg N yr$^{-1}$', transform=ax2.transAxes, fontsize=fstic, ha='center', va='center')
...
proj.drawparallels(range(domain_draw[0], domain_draw[2]+1, dlat), labels=[False,True,False,False], color=(.3,.3,.3), linewidth=0, fontsize=fstic)
plt.text(0.5,1.075, '$\Delta$ water column denitrification = 2.3 Tg N yr$^{-1}$', transform=ax3.transAxes, fontsize=fstic, ha='center', va='center')
...
#proj.drawparallels(range(domain_draw[0], domain_draw[2]+1, dlat), labels=[False,True,False,False], color=(.3,.3,.3), linewidth=0, fontsize=fstic)
plt.text(0.5,1.075, '$\Delta$ sedimentary denitrification = 4.1 Tg N yr$^{-1}$', transform=ax4.transAxes, fontsize=fstic, ha='center', va='center')
...
plt.text(0.5,1.075, '$\Delta$ net primary production = 223.0 Tg N yr$^{-1}$', transform=ax5.transAxes, fontsize=fstic, ha='center', va='center')
...
#proj.drawparallels(range(domain_draw[0], domain_draw[2]+1, dlat), labels=[False,True,False,False], color=(.3,.3,.3), linewidth=0, fontsize=fstic)
proj.drawmeridians(range(domain_draw[1], domain_draw[3]+1, dlon), labels=[True,False,False,True], color=(.3,.3,.3), linewidth=0, fontsize=fstic)
plt.text(0.5,1.075, '$\Delta$ zooplankton grazing = 306 Tg N yr$^{-1}$', transform=ax6.transAxes, fontsize=fstic, ha='center', va='center')
