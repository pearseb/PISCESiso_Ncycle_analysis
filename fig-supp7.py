...
fig.savefig('fig-supp7.png', dpi=300, bbox_to_inches='tight')
fig.savefig('fig-supp7.eps', dpi=300, bbox_to_inches='tight')
fig.savefig('fig-supp7_trans.png', dpi=300, bbox_to_inches='tight', transparent=True)
