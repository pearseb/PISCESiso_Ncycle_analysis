...
plt.savefig('fig-supp3.png',dpi=300,bbox_inches='tight')
plt.savefig('fig-supp3.pdf',dpi=300,bbox_inches='tight')
plt.savefig('fig-supp3_trans.png',dpi=300,bbox_inches='tight',transparent=True)
