...
fig.savefig('fig-supp10.png', dpi=300, bbox_inches='tight')
fig.savefig('fig-supp10.eps', dpi=300, bbox_inches='tight')
fig.savefig('fig-supp10_trans.png', dpi=300, bbox_inches='tight', transparent=True)
