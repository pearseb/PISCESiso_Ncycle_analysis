...
fig.savefig('fig-supp4.png',dpi=300,bbox_to_inches='tight')
fig.savefig('fig-supp4.eps',dpi=300,bbox_to_inches='tight')
fig.savefig('fig-supp4_trans.png',dpi=300,bbox_to_inches='tight', transparent=True)
